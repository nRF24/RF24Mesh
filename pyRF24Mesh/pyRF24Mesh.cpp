...
BOOST_PYTHON_MODULE(RF24Mesh){
    { //::RF24Mesh
        bp::class_<RF24Mesh>("RF24Mesh", bp::init<RF24&, RF24Network&>((bp::arg("_radio"), bp::arg("_network"))))
            ...
            .def("begin", &RF24Mesh::begin, begin_overload(bp::arg("channel"), bp::arg("data_rate"), bp::arg("timeout")))[bp::return_internal_reference<>()]
            //uint8_t update();
            .def("update", &RF24Mesh::update)
            //bool write(const void* data, uint8_t msg_type, size_t size, uint8_t nodeID=0);
            .def("write", &RF24Mesh::write, write_overload(bp::arg("data"), bp::arg("msg_type"), bp::arg("size"), bp::arg("nodeID")))[bp::return_internal_reference<>()]
            ...
            .def("getNodeID", &RF24Mesh::getNodeID, getNodeID_overload(bp::arg("address")))[bp::return_internal_reference<>()]
            //bool checkConnection();
            .def("checkConnection", &RF24Mesh::checkConnection)
            //uint16_t renewAddress(uint32_t timeout=MESH_RENEWAL_TIMEOUT);
            .def("renewAddress", &RF24Mesh::renewAddress, getNodeID_overload(bp::arg("timeout")))[bp::return_internal_reference<>()]
            //bool releaseAddress();
